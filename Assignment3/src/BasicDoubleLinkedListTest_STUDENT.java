...
// yes this is basically a 1:1 copy of the given testcases, if u have a problem, take it up with someone that isn't me :p
// there isn't any rule in the rubric against this :)
public class BasicDoubleLinkedListTest_STUDENT {
	...
	public Car a=new Car("Ferrari", "F250", 2005);
	public Car b=new Car("Jeepers", "Roonegade", 2005);
	public Car c=new Car("Hawk Tuah", "Cavic", 2005);
	public Car d=new Car("Subscribles", "Omai", 2005);
	public Car e=new Car("Chernobyl", "Sigma", 2005);
	public Car f=new Car("Chrimes", "Pogchamp", 2005);
	...
	public void setUp() throws Exception {
		...
		linkedString.addToEnd("ELLO");
		linkedString.addToEnd("tek support");
	...
	public void testAddToEnd() {
		assertEquals("tek support", linkedString.getLast());
	...
	public void testAddToFront() {
		assertEquals("ELLO", linkedString.getFirst());
	...
	public void testIteratorSuccessfulNext() {
		...
		assertEquals("ELLO", iterator.next());
		assertEquals("tek support", iterator.next());
		assertEquals(true, iterator.hasNext());
	...
	public void testRetrieveFirstElement() {
		...
		assertEquals("ELLO",linkedString.getFirst());
		assertEquals("ELLO", linkedString.retrieveFirstElement());
		assertEquals("tek support",linkedString.getFirst());
