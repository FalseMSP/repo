...
public class SortedDoubleLinkedListTest_STUDENT {
	...
	public void testAddToEnd() {
		try {
			sortedLinkedString.addToEnd("ELLO");
	...
	public void testAddToFront() {
		try {
			sortedLinkedString.addToFront("ELLO");
			assertTrue("Did not throw an UnsupportedOperationException", false);
		}
		catch (UnsupportedOperationException e)
		{
	...
	public void testIteratorSuccessfulStringPrevious() {
		...
		sortedLinkedString.add("Tek support");
		sortedLinkedString.add("ELLO");
		...
		assertEquals("Tek support", iterator.previous());
		assertEquals("ELLO", iterator.previous());
	}
	@Test
